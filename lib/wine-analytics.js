...
export const WINE_LANDING_KEYS = {
  ...
  "/wine/cabernet-franc": "wine_cabernet_franc",
  "/wine/pinot-noir": "wine_pinot_noir",
  "/wine/chardonnay": "wine_chardonnay",
  "/wine/sauvignon-blanc": "wine_sauvignon_blanc",
  "/wine/gewurztraminer": "wine_gewurztraminer",
  "/wine/merlot": "wine_merlot",
  "/wine/pinot-gris": "wine_pinot_gris",
  "/compare-wineries": "wine_compare",
  "/wine-country-now": "wine_country_now",
  "/wine-country-data": "wine_country_data",
  "/my-wine-journal": "wine_journal",
};
...
export const WINE_EVENT_NAMES = [
  ...
  "wine_now_opened",
  "wine_event_source_opened",
  "wine_data_filter_changed",
  "wine_data_download_opened",
  "wine_data_citation_copied",
  "wine_journal_saved",
  "wine_journal_removed",
  "wine_journal_quick_added",
  "wine_journal_summary_copied",
];
